...
class About extends Component {
    ...
    render() {
        return (
            <Grid>
                <Row className='show-grid about-one'>
                ...
                <Row className='show-grid'>
                    <Col xs={12}>
                        <div className='jobs-container'>
                            ...
                            <p className='about_jobs-paragraph'>We are always looking for talented individuals to join our NYC-based team. Our team is full of people who are passionate about fashion and committed to constantly improving our community marketplace.</p>
                            <p className='about_jobs-paragraph'>Interested in working with us? We are always hiring engineers, and you can see all job postings here.</p>
                            <p className='about_jobs-paragraph'>Don't see what you're looking for? Send us an email at jobs@grailed.com and tell us about yourself. Please make sure to attach a CV and relevant work experience.</p>
                        </div>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col>
                        <div className='code-of-conduct'>
                            <h1 className='about_code-header'>Marketplace Code of Conduct</h1>
                            <ol className='about_rules-list'>
                                <li>Be respectful when dealing with other users. Bad behavior will not be tolerated.</li>
                                <li>Follow rule #1.</li>
                                <li>Do not send frivolous offers. We understand that you cannot always follow through, but you should make a good faith effort to do so on each and every offer you make.</li>
                                <li>Do not sell fake or replica items. Any seller doing so will be banned.</li>
                                <li>Ship items you sell in a timely manner, ideally within 72 hours and no longer than 5 days after purchase.</li>
                                <li>Be honest and accurate in your item descriptions. Make sure to highlight any flaws or distinctive details.</li>
                                <li>Communicate well. Keep buyers updated on the status of their orders and send tracking whenever possible.</li>
                                <li>Respect the Grailed Curation team. Items are moved and deleted at their discretion.</li>
                                <li>Do not advertise your items in any of the comment sections (listings or editorial articles). These sections are designated for discussion and any solicitations will be removed.
                                </li>
                            </ol>
                        </div>
                    </Col>
